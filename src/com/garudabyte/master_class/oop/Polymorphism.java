...
public class Polymorphism {
    public static void main(String[] args) {
        ...
        PolymorphismMovie theMovieComedy  = PolymorphismMovie.getMovie("com.garudabyte.master_class.oop.Comedy","com.garudabyte.master_class.oop.Comedy");
...
//        com.garudabyte.master_class.oop.PolymorphismMovie comedyMovie = (com.garudabyte.master_class.oop.PolymorphismMovie) comedy;
//        comedyMovie.watchMovie();
        ...
        if(unknownObject.getClass().getSimpleName() == "com.garudabyte.master_class.oop.Comedy"){
...
unknownObject instanceof com.garudabyte.master_class.oop.Adventure
it's important to see that com.garudabyte.master_class.oop.Adventure is not quotes, meaning we're testing the type name, but the actual type
this operator returns true, if the unknownObject is an instance of com.garudabyte.master_class.oop.Adventure
*/